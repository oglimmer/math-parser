...
public class DecimalTest {
    ...
    public void simpleAddition() {
        ...
        Assertions.assertEquals(68.5d, n.resolve(new HashMap<>()));
    }
    ...
    public void simpleSubtraction() {
        ...
        Expression n = new FunctionParser().parse(input);
        Assertions.assertEquals(100.6d, n.resolve(new HashMap<>()));
    }
    ...
    public void doubleAddition() {
        ...
        Expression n = new FunctionParser().parse(input);
        Assertions.assertEquals(69.5d, n.resolve(new HashMap<>()));
    }
    ...
    public void doubleSubtraction() {
        ...
        Expression n = new FunctionParser().parse(input);
        Assertions.assertEquals(66.60000000000001, n.resolve(new HashMap<>()));
    }
    ...
    public void additionAndSubtraction() {
        ...
        Expression n = new FunctionParser().parse(input);
        Assertions.assertEquals(114.00000000000001, n.resolve(new HashMap<>()));
    }
    ...
    public void multipleAdditionAndSubtraction() {
        ...
        Expression n = new FunctionParser().parse(input);
        Assertions.assertEquals(179.20000000000002, n.resolve(new HashMap<>()));
    }
    ...
    public void simpleDivision() {
        String input = "6/4";
        Expression n = new FunctionParser().parse(input);
        Assertions.assertEquals(1.5d, n.resolve(new HashMap<>()));
    }
    ...
    public void addingAndDivision3() {
        ...
        Expression n = new FunctionParser().parse(input);
        Assertions.assertEquals(1.25d, n.resolve(new HashMap<>()));
    }
    ...
    public void addingAndDivision4() {
        ...
        Expression n = new FunctionParser().parse(input);
        Assertions.assertEquals(9.25d, n.resolve(new HashMap<>()));
    }
    ...
    public void addingAndDivision5() {
        ...
        Expression n = new FunctionParser().parse(input);
        Assertions.assertEquals(11.25d, n.resolve(new HashMap<>()));
    }
    ...
    public void addingAndSubtractionAndDivision() {
        ...
        Expression n = new FunctionParser().parse(input);
        Assertions.assertEquals(37.25d, n.resolve(new HashMap<>()));
    }
}
